...
// reveal: 스카우터 사용 시 공개되는 정보 (mainPos=주 포지션, subPos=부 포지션, champions=모스트 1개)
//  · 황금카드(올 포지션)는 포지션이 없으므로 모스트만 공개 (전용 비용 goldenScoutCost)
export const GAME_PRESETS = {
  "오버워치": {
    roles: [{ name: "탱커", count: 1 }, { name: "딜러", count: 2 }, { name: "힐러", count: 2 }],
    phase1Role: "탱커", // 선(先)경매 포지션 — 1페이즈에 먼저 경매
    reveal: ["mainPos", "subPos", "champions"],
  },
  "리그 오브 레전드": {
