...
//    · 15구간(50레벨 간격)을 8티어(100레벨 간격)로 합쳤고, 기존 곡선과의 차이는 ±150 이내다.

export const VOICE_TIERS = [
  { key: "iron",     name: "아이언",     en: "IRON",     min: 0,   bonus: 0,    c: "#8a8a8a" },
  { key: "bronze",   name: "브론즈",     en: "BRONZE",   min: 100, bonus: 300,  c: "#a06a3c" },
  { key: "silver",   name: "실버",       en: "SILVER",   min: 200, bonus: 550,  c: "#8d99a6" },
  { key: "gold",     name: "골드",       en: "GOLD",     min: 300, bonus: 750,  c: "#c39220" },
  { key: "platinum", name: "플래티넘",   en: "PLATINUM", min: 400, bonus: 1100, c: "#3f9e93" },
  { key: "diamond",  name: "다이아몬드", en: "DIAMOND",  min: 500, bonus: 1500, c: "#3f7fc4" },
  { key: "master",   name: "마스터",     en: "MASTER",   min: 600, bonus: 1900, c: "#8557b0" },
  // 최고 티어는 커뮤니티 이름 그대로 — 여기까지 오면 이글루 그 자체
  { key: "igloo",    name: "이글루",     en: "IGLOO",    min: 700, bonus: 3000, c: "#e91e3f" },
];
