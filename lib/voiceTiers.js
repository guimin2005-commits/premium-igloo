...
export const VOICE_TIERS = [
  ...
  { key: "bronze",      name: "브론즈",       en: "BRONZE",      min: 90,  bonus: 300,  point: 500,  c: "#a06a3c" },
  { key: "silver",      name: "실버",         en: "SILVER",      min: 160, bonus: 550,  point: 1000,  c: "#8d99a6" },
  { key: "gold",        name: "골드",         en: "GOLD",        min: 240, bonus: 750,  point: 1800,  c: "#c39220" },
  { key: "platinum",    name: "플래티넘",     en: "PLATINUM",    min: 330, bonus: 1100, point: 2800, c: "#3f9e93" },
  { key: "diamond",     name: "다이아몬드",   en: "DIAMOND",     min: 430, bonus: 1500, point: 4000, c: "#3f7fc4" },
  { key: "master",      name: "마스터",       en: "MASTER",      min: 540, bonus: 1900, point: 5500, c: "#8557b0" },
  { key: "grandmaster", name: "그랜드마스터", en: "GRANDMASTER", min: 650, bonus: 2200, point: 7500, c: "#a03a6b" },
  { key: "challenger",  name: "챌린저",       en: "CHALLENGER",  min: 760, bonus: 2500, point: 10000, c: "#c2452f" },
  // 최고 티어는 커뮤니티 이름 그대로 — 여기까지 오면 이글루 그 자체
  { key: "igloo",       name: "이글루",       en: "IGLOO",       min: 880, bonus: 3000, point: 15000, c: "#e91e3f" },
];
