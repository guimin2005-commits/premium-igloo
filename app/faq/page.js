  ...
  const faqData = [
    {
      ...
      items: [
        ...
        { q: "레벨이 오르면 어떤 구체적인 혜택이 있나요?", t: "단계별 전용 혜택 여부", a: "특정 레벨마다 전용 레벨 역할 및 색상 혜택이 적용됩니다. 레벨이 상승할수록 IGLOO SHOP 내 이용 가능한 상품 라인업이 점진적으로 확대됩니다.\nIGLOO SHOP에는 서버 이용 편의를 돕는 권한 상품이 포함되어 있으니, 구매를 통해 최적화된 서버 환경을 경험해 보시기 바랍니다." },
        { q: "서버 퇴장 시 XP 및 LEVEL이 유지 되나요?", t: "서버 데이터 유지 여부", a: "유지되지 않습니다. 2026-04-11(토) 이후 운영 정책이 변경됨에 따라 서버 퇴장 시 즉시 XP 및 LEVEL이 모두 초기화 됩니다." }
      ]
    },
    {
      category: "IGLOO SHOP 및 아이템 상품",
      items: [
    ...
    },
    {
      category: "코드 등록",
      items: [
        { q: "받은 코드는 어디서 사용하나요?", t: "PC / 모바일 사용 방법", a: "공식 웹사이트 로그인 후 '코드 등록' 메뉴에서 사용할 수 있습니다.\n\n[PC]\n1. 공식 웹사이트 접속 후 로그인\n2. 우측 상단 프로필 클릭 → [코드 등록]\n3. 보유한 코드를 입력 후 등록\n\n[모바일]\n1. 공식 웹사이트 접속 후 로그인\n2. 우측 상단 삼선(≡) 메뉴 클릭 → 하단 [코드 등록]\n3. 보유한 코드를 입력 후 등록" },
        { q: "코드를 입력했는데 사용할 수 없다고 나와요.", t: "사용 불가 사유 안내", a: "다음의 경우 코드 사용이 제한될 수 있습니다.\n\n· 이미 사용한 코드 (1인 1회)\n· 사용 기한이 만료된 코드\n· 사용 한도(선착순 수량)가 소진된 코드\n· 특정 역할 소지자 전용 코드 (해당 역할 미보유 시)\n\n위 사항에 해당하지 않는데도 오류가 발생한다면 1:1 문의로 접수해 주세요." },
      ]
    },
    {
      category: "MUSIC BOT",
