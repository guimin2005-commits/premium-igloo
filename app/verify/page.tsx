    ...
    sections: [
      {
        heading: "이용 조건",
        items: [
          { desc: "ARCTIC은 보유 XP·빙옥(1 빙옥 = 1,000 XP)으로 역할·권한·쿠폰 등을 교환하는 공식 상점이며, 현금 결제는 지원하지 않습니다." },
      ...
      },
      {
        heading: "구매 및 지급",
        items: [
          { desc: "구매 시 사용한 XP·빙옥이 즉시 차감되며, XP 차감으로 레벨이 하락하고 레벨 연동 역할이 회수될 수 있습니다." },
      ...
      },
      {
        ...
        items: [
          ...
          { term: "XP·빙옥 원복 가능 사유", desc: "지급 누락 · 중복 결제 · 상품 정보 오류 — 발생일로부터 7일 이내 문의 창구로 접수" },
