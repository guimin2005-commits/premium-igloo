                  ...
                  <div key={a.key} className="border-b border-white/10">
                    <div className="flex items-center gap-3 py-4 px-1">
                      ...
                      <button type="button" onClick={() => toggleTab(a.key)} aria-expanded={open} className="flex-1 min-w-0 text-left flex items-center gap-2 group">
                        <span className="font-semibold text-gray-200 group-hover:text-white text-sm md:text-[15px] transition-colors">{a.title}<span className="text-[#e91e3f] ml-1" aria-hidden="true">*</span></span>
                      </button>
