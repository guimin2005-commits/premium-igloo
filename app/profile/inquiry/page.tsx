        ...
        <div className="border-t border-black/[0.08]">
          {rows === null ? (
            ...
            <div className="divide-y divide-black/[0.06]">
              {list.map((inq) => (
                <Link key={inq.id} href={`/profile/inquiry/${inq.id}`} className="w-full text-left py-3.5 px-1 flex items-center gap-3.5 hover:bg-black/[0.02] transition-colors group outline-none">
