...
const SectionHead = ({ no, title }: { no: string; title: string }) => (
  <div className="mb-4">
    <div className="flex items-baseline gap-4 mb-2">
      ...
      <div className="h-px flex-1 bg-gradient-to-r from-[#e0e0e0] to-transparent"></div>
    </div>
  ...
  return (
    <main className="w-full flex-1 flex flex-col text-[#131313] animate-in fade-in duration-500">
      ...
      <section className="w-full max-w-4xl mx-auto px-6 pt-10 pb-20">
        ...
        {isBooster && (
          <div className="mb-6 rounded-2xl border border-[#ededed] bg-white px-5 py-4 flex items-center gap-3 break-keep">
            ...
            <p className="text-[13px] font-bold text-[#5a5a5a]">부스터 혜택이 적용 중입니다. 아래 혜택이 자동으로 지급됩니다.</p>
          </div>
        )}
        ...
        <div className="space-y-6">
            ...
            {/* 01. 전용 기능 권한 */}
            <Reveal>
            <div className="bg-white rounded-2xl border border-[#ededed] p-6 md:p-7">
