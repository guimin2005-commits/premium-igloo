...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const categoryGroups = [
    ...
    { name: "콘텐츠", desc: "서버의 핵심 콘텐츠", tagline: "서버의 핵심 콘텐츠", items: [{ name: "SYSTEM : LEVEL", path: "/level", desc: "레벨 시스템 및 XP 대시보드" }, { name: "대회", path: "/tournament", desc: "e스포츠 리그 허브" }, { name: "선수 경매", path: "/auction", desc: "실시간 선수 경매 관전 및 참여" }, { name: "구인", path: "/recruit", desc: "스태프 및 서포터즈 모집" }, { name: "명예의 전당", path: "/hall-of-fame", desc: "역대 대회 우승 기록" }, { name: "부스터 혜택", path: "/booster", desc: "서버 부스터 전용 혜택 안내" }] },
