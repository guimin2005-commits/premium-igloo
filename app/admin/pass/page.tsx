                        ...
                        return (
                          ...
                          <div key={t.key} className="flex items-center gap-3 py-3.5">
                            ...
                            <span className="flex-1 min-w-0 pl-4 flex items-center gap-2">
                              ...
                              <span className={`text-[12px] font-bold truncate ${t.free.kind === "none" ? "text-[#a3a3a3]" : "text-[#5a5a5a]"}`}>
                                {rewardLabel(t.free, roleNameOf, itemOf)}
                              </span>
                            </span>
                            <span className="flex-1 min-w-0 flex items-center gap-2">
                              <span className="w-1.5 h-1.5 rounded-full shrink-0 bg-[#e91e3f]"></span>
                              <span className={`text-[12px] font-bold truncate ${t.paid.kind === "none" ? "text-[#a3a3a3]" : "text-[#5a5a5a]"}`}>
