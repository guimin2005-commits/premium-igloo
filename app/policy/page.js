      ...
      {tab === "terms" ? (
        ...
        <div className="space-y-7 text-sm">
          ...
          <Article title="제5조 (시즌 운영)">
            <NumberedList items={[
              ...
              "기간제 아이템은 구매할 때 고른 기간이 지나면 효력이 끝납니다. 시즌 전환 시 표기를 떼도록 지정된 역할 상품은 시즌이 바뀌면 디스코드 역할 표기가 해제되며, 인벤토리의 보유 기록은 유지됩니다.",
        ...
        <div className="space-y-7 text-sm">
          <Article title="제1조 (목적 및 정의)">
            ...
            <DefList items={[
              { term: "ARCTIC", desc: "이용자가 보유 XP·빙옥을 사용하여 역할·권한·쿠폰 등의 상품을 교환하는 고급 이글루 공식 상점" },
              { term: "결제 수단", desc: "보유 XP와 빙옥(1 빙옥 = 1,000 XP)을 함께 사용할 수 있습니다. 빙옥으로 내는 금액은 XP 가격을 1,000으로 나눈 값을 올림하여 계산합니다. 현금 결제는 지원하지 않습니다." },
          ...
          <Article title="제4조 (취소 및 환불)">
            <p>XP와 빙옥은 법정 통화가 아니므로 현금 환불의 대상이 되지 않습니다. 다만 아래의 경우에 한해 XP·빙옥 원복 또는 재지급을 요청할 수 있습니다.</p>
            <DefList items={[
              { term: "지급 누락", desc: "XP·빙옥이 차감되었으나 상품(역할 등)이 지급되지 않은 경우" },
