        ...
        <div className="space-y-7 text-sm">
          <Article title="제1조 (대회 참가 및 자격 규정)">
            <ul className="space-y-3 list-disc pl-5 marker:text-gray-600">
              ...
              <li>모든 참가자는 경기 시작 <span className="text-white font-bold">[15분 전]</span>까지 지정된 디스코드 음성 채널에 접속하여 대기해야 합니다.</li>
          ...
          <Article title="제3조 (경기 중단·퍼즈 및 분쟁 규정)">
            <ul className="space-y-3 list-disc pl-5 marker:text-gray-600">
              <li>경기 중 인터넷 문제, 튕김(디스콘), 심각한 렉 등이 발생할 경우 즉시 퍼즈(일시정지)를 걸고 관리자를 호출해야 합니다. (팀당 최대 퍼즈 시간 <span className="text-white font-bold">[10분]</span> 제한)</li>
