...
export default function Dropdown({
  ...
  useEffect(() => {
    ...
    // preventDefault — 이 Esc 는 목록을 닫는 데 썼다고 알린다(관리자 상세 칸 등 뒤의 창이 같이 닫히지 않게)
  ...
  const button = isLight
    ? "w-full bg-white border border-[#ededed] rounded-lg px-4 py-3 text-sm text-[#131313] hover:border-[#a3a3a3] focus:border-[#e91e3f]"
  ...
  const scrollbar = isLight
    ? "[&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-[#e0e0e0] [&::-webkit-scrollbar-thumb]:rounded-full"
