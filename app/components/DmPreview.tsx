        ...
        <div className="min-w-0 flex-1 px-3.5 py-3">
          ...
          <div className="flex flex-wrap gap-x-10 gap-y-3 mt-3">
            <span className="block">
              <span className="block text-[11px] font-black text-gray-200">팀</span>
              <span className="block text-[12px] text-gray-400 mt-0.5">{teamName || "—"}</span>
            </span>
            {dueAt && (
              <span className="block">
                <span className="block text-[11px] font-black text-gray-200">마감</span>
                <span className="block text-[12px] text-gray-400 mt-0.5 tabular-nums">{fmtKst(dueAt)}</span>
                <span className="block text-[12px] text-gray-400">{untilLabel(dueAt)}</span>
              </span>
            )}
          </div>
